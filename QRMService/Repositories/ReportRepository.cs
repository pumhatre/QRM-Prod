...
namespace QRMService.Repositories
{
    public class ReportRepository
    {
        ...
        public static List<ProductivityGrid> GetProductivity()
        {

            List<ProductivityGrid> productivityGrids = new List<ProductivityGrid>();
            List<Productivity> ProductivitytListGroundUp = new List<Productivity>();
            List<Productivity> ProductivitytListGroundUp2 = new List<Productivity>();
            ...
            ProductivitytListGroundUp2.Add(new Productivity
            {
                Type = "UI Components",
                SubType = "Functional Design",
                LSL = 51,
            ...
            productivityGrids.Add(new ProductivityGrid
            {
                productivities = ProductivitytListGroundUp
            });
            productivityGrids.Add(new ProductivityGrid
            {
                productivities = ProductivitytListGroundUp2
            });

            return productivityGrids;
        }
