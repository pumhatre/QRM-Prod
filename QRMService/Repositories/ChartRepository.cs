...
namespace QRMService.Repositories
{
    public static class ChartRepository
    {
        ...
        public static ChartDataModelDecimal GetEffortDistribution(int projectId, int releaseId, int savedChartId)
        {
            ...
            if (savedChartId > 0)
            {
                return JsonConvert.DeserializeObject<ChartDataModelDecimal>(System.Text.Encoding.UTF8.GetString(GetSavedChartReport(savedChartId)));
            }
            else
            {
        ...
        public static ChartDataModelDecimal GetTestCaseDistribution(int projectId, int releaseId, int savedChartId)
        {
            var helper = new SqlClientHelper();
            List<KeyValuePair<string, object>> parameters = new List<KeyValuePair<string, object>>();
            parameters.Add(new KeyValuePair<string, object>("projectId", projectId));
        ...
        public static ChartDataModelDecimal GetTestCaseComplexityDistribution(int projectId, int releaseId, int savedChartId)
        {
            var helper = new SqlClientHelper();
            List<KeyValuePair<string, object>> parameters = new List<KeyValuePair<string, object>>();
            parameters.Add(new KeyValuePair<string, object>("projectId", projectId));
        ...
        public static ChartDataModelDecimal GetDefectDetectedPhaseDistribution(int projectId, int releaseId, int savedChartId)
        {
            var helper = new SqlClientHelper();
            List<KeyValuePair<string, object>> parameters = new List<KeyValuePair<string, object>>();
            parameters.Add(new KeyValuePair<string, object>("projectId", projectId));
        ...
        public static ChartDataModel GetDevelopementWidgetDashboard(int projectId, int releaseId, int savedChartId)
        {
            ...
            if (savedChartId > 0)
            {
                return JsonConvert.DeserializeObject<ChartDataModel>(System.Text.Encoding.UTF8.GetString(GetSavedChartReport(savedChartId)));
            }
            else
            {
        ...
        public static ChartDataModel GetSITDefectSeverity(int projectId, int releaseId, int savedChartId)
        {
            var helper = new SqlClientHelper();
            List<KeyValuePair<string, object>> parameters = new List<KeyValuePair<string, object>>();
            parameters.Add(new KeyValuePair<string, object>("ProjectId", projectId));
        ...
        public static ChartDataModel GetDefectTypeDistribution(int projectId, int releaseId, int savedChartId)
        {
            var helper = new SqlClientHelper();
            List<KeyValuePair<string, object>> parameters = new List<KeyValuePair<string, object>>();
            parameters.Add(new KeyValuePair<string, object>("ProjectId", projectId));
        ...
        public static ChartDataModel GetSitExecutionGrapgh(int projectId, int releaseId, int savedChartId)
        {
            var helper = new SqlClientHelper();
            List<KeyValuePair<string, object>> parameters = new List<KeyValuePair<string, object>>();
            parameters.Add(new KeyValuePair<string, object>("ProjectId", projectId));
        ...
        public static ChartDataModel GetSitDefectGraph(int projectId, int releaseId, int savedChartId)
        {
            var helper = new SqlClientHelper();
            List<KeyValuePair<string, object>> parameters = new List<KeyValuePair<string, object>>();
            parameters.Add(new KeyValuePair<string, object>("ProjectId", projectId));
        ...
        private static byte[] GetSavedChartReport(int chartReportId)
        {
            var helper = new SqlClientHelper();
            List<KeyValuePair<string, object>> parameters = new List<KeyValuePair<string, object>>();
            parameters.Add(new KeyValuePair<string, object>("ReportId", chartReportId));
            DataTable dt = helper.GetDataTableByProcedure(Constants.UspGetSavedChartData, "default", true, parameters.ToArray());
