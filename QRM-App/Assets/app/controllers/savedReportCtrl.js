...
angular.module('savedReport', ['ngAnimate', 'ngTouch', 'ui.grid', 'ui.grid.saveState', 'ui.grid.selection', 'ui.grid.cellNav', 'ui.grid.resizeColumns', 'ui.grid.moveColumns', 'ui.grid.pinning', 'ui.bootstrap', 'ui.grid.autoResize', 'chart.js'])
    .controller('savedReportCtrl', ['$scope', '$cookies', '$cookieStore', 'config', 'uiGridConstants', '$templateCache', 'mySavedReportService', '$rootScope', function ($scope, $cookies, $cookieStore, config, uiGridConstants, $templateCache, mySavedReportService, $rootScope) {
        ...
        $scope.savedReportsGrid = {
            ...
            columnDefs: [
                ...
                { field: 'ReportName', name: 'ReportName', cellTemplate: tmpl, width: '45%' },
                {
                    ...
                    cellTemplate: '<div style="text-align: center; padding-top: 5px; padding-bottom: 5px;"><button ng-show="!row.entity.editable" ng-click="grid.appScope.redirectToChart(row.entity.ProjectId,row.entity.ProjectReleaseID,row.entity.ReportType)" class="btn btn-info btn-xs"><i class="glyphicon glyphicon-th-list"></i> View</button>' +  //View Button
