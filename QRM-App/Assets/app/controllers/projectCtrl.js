            ...
            $scope.gridOptions = {
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        cellTemplate: '<div><button style="padding: 5px;" ng-show="!row.entity.editrow" ng-click="grid.appScope.edit(row.entity)" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>Edit</button>' +  //Edit Button
